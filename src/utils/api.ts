...
// import Notify from "../components/vant/notify";
...
export function beautifyArticleList(rawArticleList) {
    ...
    rawArticleList.forEach((itm: any) => {
        ...
        articleList.push(itm);
    });
    return articleList;
}

export interface IBoardDataParamsInterface {
    start: number;
    count: number;
    city: string;
    q: string;
...
export function getBoardData({
    ...
    const params: IBoardDataParamsInterface = {
        city: "",
        count: 0,
        q: "",
        start: 0,
